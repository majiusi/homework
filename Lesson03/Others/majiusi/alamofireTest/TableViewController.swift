...
//    }
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return structLibs.count
    }
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "table", for: indexPath)
        for index in 0...structLibs.count{
            if indexPath.row == index {
                cell.textLabel?.text = structLibs[index].name
                cell.detailTextLabel?.text = structLibs[index].region
            }
        }
//        for line in structLibs{
//            cell.textLabel?.text = line.name
//            cell.detailTextLabel?.text = line.region
//        }
        return cell
    }
